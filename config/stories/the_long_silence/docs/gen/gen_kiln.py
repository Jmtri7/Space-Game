    ...
    {"name": "Factor Tol", "x": 800, "y": 410, "role": "stationmaster",
     ...
     "dialogue_tree": {"root": "start", "conditional_roots": [
      ...
      "nodes": {
        ...
        "signed": {"text": "Terms: the manifest is sealed, you do not open it, you do not deviate. Tallykeeper Vess holds it - the Assay Office, the north side of the Hold. The Warden of Contract witnesses your mark first.",
...
CONTRACT = {
    ...
    "stages": [
        {"text": "Have your mark witnessed - Warden of Contract Raik, the Contract Hall (north-west of the Hold).",
         "complete_flag": "combine_witnessed",
         "one_way_message": say(FAC, "The Warden of Contract witnesses first. The Contract Hall stands on the north-west of the Hold floor. Put your hand on the seal-stone.")},
        {"text": "Collect the sealed manifest from Tallykeeper Vess, the Assay Office (north side of the Hold).",
         "complete_flag": "combine_manifest_taken",
         "one_way_message": say(FAC, "Vess has the manifest in the Assay Office, north side of the Hold. Sealed. You carry it - you do not open it.")},
