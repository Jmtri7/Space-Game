...
RECORD = {
    ...
    "stages": [
        {"text": "Read the First Wall with Warden of Names Vane - the Long Vault (north-west).",
        ...
        {"text": "Read the middle years with Brother Sol - the Reading Cells (north).",
        ...
        {"text": "Enter the Vault of the First Decade with Sister Edda (north-east).",
