    ...
    {"name": "Induction Officer Sella", "x": 780, "y": 660, "role": "concierge",
     ...
     "dialogue_tree": {"root": "start", "conditional_roots": [
      ...
      "nodes": {
        ...
        "accepted": {"text": "Good. Close the comm and lead off down the concourse - I'm right behind you.",
        ...
        "declined": {"text": "Understood. The Berth's east for a hull, the Lender's Office south-west for the credits. Kiln's beacon lights when you're ready to leave - come back and tell me. Safe flying.",
...
INDUCTION = {
    ...
    "stages": [
        {"text": "Walk a lap of the Approach Concourse - WASD or the arrow keys.",
         ...
         "one_way_message": say(IND, "You're on the induction - it tracks in your Mission Log (N). Feet first: walk the length of the concourse on WASD or the arrow keys.")},
        ...
        {"text": "Walk up to someone and talk - press T.",
         ...
         "one_way_message": say(IND, "Get in close to anyone and press T. Shopkeepers open their store; everyone else has something to say - and most of it's worth hearing right now.")},
        ...
        {"text": "Open your Possessions - press P (check the Standing panel).",
         ...
         "one_way_message": say(IND, "Press P for Possessions - credits, ships, cargo, and your Standing with each faction. Right now you're Friendly with the Authority and neutral everywhere else. That will change.")},
        {"text": "Take the Authority starter loan - Signal Officer Doss, Lender's Office (south-west).",
         "complete_flag": "took_loan",
         "one_way_message": say(IND, "South-west bay, the Lender's Office. Talk to Signal Officer Doss and take the starter loan - you'll need it for a hull.")},
        {"text": "Buy a ship - Harbor-Master Crane, the Berth (north-east).",
         "complete_flag": "bought_ship",
         "one_way_message": say(IND, "Now the Berth, north-east. Harbor-Master Crane has hulls for sale - the courier's an easy first ship. Buy whichever you like.")},
