...
INDUCTION = {
    ...
    "stages": [
        ...
        {"text": "Board your ship - step on the Berth portal and press G.",
         "complete_flag": "boarded_ship",
         "one_way_message": say(IND, "That's the ring done. Your ship's docked at the Berth - step on the portal and press G to board. I'll raise you once you're in the cockpit.")},
