...
MESSAGE_SPACING_FRAMES = 450      # ~7.5s at 60fps - minimum gap between one-way Message Log posts when several land close together (see _post_message / _pump_message_queue)
