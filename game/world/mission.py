...
def check_mission_progress(missions_config, possessions):
    ...
    completed_missions if that was the last one. Call this every frame
    (see SpaceScreen.update_physics) so a flag set by any means (a
    dialogue choice, a gameplay event) is picked up promptly regardless of
    which screen actually set it."""
